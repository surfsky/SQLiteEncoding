        ...
        IntPtr pAuthContext)
    {
        try
        {
            AuthorizerEventArgs eventArgs = new AuthorizerEventArgs(pUserData, actionCode,
                SQLiteBase.PtrToString(pArgument1, -1), SQLiteBase.PtrToString(pArgument2, -1),
                SQLiteBase.PtrToString(pDatabase, -1), SQLiteBase.PtrToString(pAuthContext, -1),
        ...
        )
    {
        try
        {
            _updateHandler(this, new UpdateEventArgs(
              SQLiteBase.PtrToString(database, -1),
              SQLiteBase.PtrToString(table, -1),
        ...
        try
        {
            if (_traceHandler != null)
                _traceHandler(this, new TraceEventArgs(
                  SQLiteBase.PtrToString(statement, -1)));
        }
        catch (Exception e) /* NOTE: Must catch ALL. */
        {
            try
