...
namespace System.Data.SQLite
{
  ...
  public abstract class SQLiteConvert
  {
    ...
    /// </summary>
    public static Encoding Enc = new UTF8Encoding();
    /// <summary>
    ...
    public static byte[] ToBytes(string sourceText)
    {
    ...
    {
      return ToBytes(ToString(dateTimeValue));
    }
    ...
    {
      return PtrToString(nativestring, nativestringlen);
    }
    ...
    /// <param name="nativeStringLen">The number of bytes to decode</param>
    /// <returns>A string containing the translated character(s)</returns>
    public static string PtrToString(IntPtr nativeString, int nativeStringLen)
    {
